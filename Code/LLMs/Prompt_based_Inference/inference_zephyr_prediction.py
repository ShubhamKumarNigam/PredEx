...
for i,row in tqdm(df_test.iterrows()):
    ...
    template = f"""Task: Given a Supreme Court of India case proceeding enclosed in angle brackets <>, your task is to predict the decision/verdict of the case (with respect to the appelant). \
...
#     if i==20:
#         break
df_test.to_csv('results/zephyr_prediction.csv', index=False)
