...
model_name = 'law-ai/InCaseLawBERT' #'xlnet-base-cased' #'xlnet-large-cased' 'law-ai/InLegalBERT' 
...
model = BertForSequenceClassification.from_pretrained("law-ai/InCaseLawBERT", num_labels=2)
...
output_dir = out_path + '/InCaseLawBERT_15k/'
