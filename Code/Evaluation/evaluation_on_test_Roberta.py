...
output_dir = out_path + '/Roberta/'


device = torch.device('cuda:1' if torch.cuda.is_available() else 'cpu')
model = RobertaForSequenceClassification.from_pretrained(output_dir, num_labels=2)
...
out_df.to_csv('Roberta_prediction.csv', index=False)
